...
REM Workfile:@(#)rmidemo.bat	1.19
REM Version:1.19
REM Modified:09/29/03 17:06:16

@echo on
@echo This demo requires a cref or jcwde with com.sun.javacard.RMIDemo applet
...
%JAVA_HOME%\bin\java -classpath %JC_RMICPATH%;%CLASSPATH% com.sun.javacard.clientsamples.purseclient.PurseClient %1
